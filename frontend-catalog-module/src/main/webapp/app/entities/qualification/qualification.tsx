  ...
  render() {
    ...
    return (
      <div>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="catalogApp.qualification.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('hyperLink')}>
                    <Translate contentKey="catalogApp.qualification.hyperLink">Hyper Link</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="catalogApp.qualification.subject">Subject</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {qualificationList.map((qualification, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      {qualification.subject ? <Link to={`subject/${qualification.subject.id}`}>{qualification.subject.name}</Link> : ''}
                    </td>
        ...
        <div className={qualificationList && qualificationList.length > 0 ? '' : 'd-none'}>
