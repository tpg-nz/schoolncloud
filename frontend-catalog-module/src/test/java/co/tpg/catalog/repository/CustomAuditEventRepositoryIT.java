...
import co.tpg.catalog.config.audit.AuditEventConverter;
import co.tpg.catalog.domain.PersistentAuditEvent;
...
import static co.tpg.catalog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
