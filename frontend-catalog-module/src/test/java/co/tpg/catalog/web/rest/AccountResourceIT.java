...
import co.tpg.catalog.config.Constants;
import co.tpg.catalog.domain.Authority;
import co.tpg.catalog.domain.User;
import co.tpg.catalog.repository.AuthorityRepository;
import co.tpg.catalog.repository.UserRepository;
import co.tpg.catalog.security.AuthoritiesConstants;
import co.tpg.catalog.service.MailService;
import co.tpg.catalog.service.UserService;
import co.tpg.catalog.service.dto.PasswordChangeDTO;
import co.tpg.catalog.service.dto.UserDTO;
import co.tpg.catalog.web.rest.errors.ExceptionTranslator;
import co.tpg.catalog.web.rest.vm.KeyAndPasswordVM;
import co.tpg.catalog.web.rest.vm.ManagedUserVM;
