package co.tpg.workflow.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, co.tpg.workflow.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, co.tpg.workflow.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, co.tpg.workflow.domain.User.class.getName());
