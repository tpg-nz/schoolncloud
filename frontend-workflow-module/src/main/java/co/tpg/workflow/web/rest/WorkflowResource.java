...
public class WorkflowResource {
    ...
    public ResponseEntity<List<Workflow>> getAllWorkflows(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
