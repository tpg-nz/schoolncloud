...
import co.tpg.workflow.config.audit.AuditEventConverter;
import co.tpg.workflow.domain.PersistentAuditEvent;
...
import static co.tpg.workflow.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
