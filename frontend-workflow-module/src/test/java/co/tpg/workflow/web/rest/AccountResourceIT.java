...
import co.tpg.workflow.config.Constants;
import co.tpg.workflow.domain.Authority;
import co.tpg.workflow.domain.User;
import co.tpg.workflow.repository.AuthorityRepository;
import co.tpg.workflow.repository.UserRepository;
import co.tpg.workflow.security.AuthoritiesConstants;
import co.tpg.workflow.service.MailService;
import co.tpg.workflow.service.UserService;
import co.tpg.workflow.service.dto.PasswordChangeDTO;
import co.tpg.workflow.service.dto.UserDTO;
import co.tpg.workflow.web.rest.errors.ExceptionTranslator;
import co.tpg.workflow.web.rest.vm.KeyAndPasswordVM;
import co.tpg.workflow.web.rest.vm.ManagedUserVM;
