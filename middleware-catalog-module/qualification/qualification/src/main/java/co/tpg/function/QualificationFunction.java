 ...
 * @since 2019-09-11
 */
public class QualificationFunction implements RequestHandler<QualificationRequest, QualificationResponse> {

    public QualificationResponse handleRequest(final QualificationRequest input, final Context context) {
